...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        st.markdown("""<style>.big-font {font-size:50px !important;font-family: 'Cooper Black'; text-align:center;}</style>""", unsafe_allow_html=True)

        st.markdown('<p class="big-font">WHATSAPP ANALYSIS</p>', unsafe_allow_html=True)
